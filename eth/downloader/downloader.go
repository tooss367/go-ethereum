...
func (d *Downloader) importBlockResults(results []*fetchResult) error {
	...
	for i, result := range results {
		blocks[i] = types.NewBlockWithHeaderAndBody(result.Header,result.Transactions, result.Uncles)
	}
...
func (d *Downloader) commitPivotBlock(result *fetchResult) error {
	block := types.NewBlockWithHeaderAndBody(result.Header,result.Transactions, result.Uncles)
