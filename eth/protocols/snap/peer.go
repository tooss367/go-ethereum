...
type PeerIF interface {
	ID() string
	RequestAccountRange(id uint64, root common.Hash, origin common.Hash, bytes uint64) error
	RequestStorageRanges(id uint64, root common.Hash, accounts []common.Hash, origin []byte, bytes uint64) error
