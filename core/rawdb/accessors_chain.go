...
func ReadBlock(db ethdb.Reader, hash common.Hash, number uint64) *types.Block {
	...
	return types.NewBlockWithHeaderAndBody(header,body.Transactions, body.Uncles)
}
...
func ReadBadBlock(db ethdb.Reader, hash common.Hash) *types.Block {
	...
	for _, bad := range badBlocks {
		if bad.Header.Hash() == hash {
			return types.NewBlockWithHeaderAndBody(bad.Header, bad.Body.Transactions, bad.Body.Uncles)
		}
	}
	return nil
}
...
func ReadAllBadBlocks(db ethdb.Reader) []*types.Block {
	...
	for _, bad := range badBlocks {
		blocks = append(blocks, types.NewBlockWithHeaderAndBody(bad.Header, bad.Body.Transactions, bad.Body.Uncles))
	}
	return blocks
}
