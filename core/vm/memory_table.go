...
var (
	uint256_32 = uint256.NewInt().SetUint64(32)
	uint256_1  = uint256.NewInt().SetUint64(1)
)
...
func memoryMLoad(stack *Stack) (uint64, bool) {
	return calcMemSize(stack.Back(0), uint256_32)
}

func memoryMStore8(stack *Stack) (uint64, bool) {
	return calcMemSize(stack.Back(0), uint256_1)
}
